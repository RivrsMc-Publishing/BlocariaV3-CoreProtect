...
public final class BlockGroup {
    ...
    public static Set<Material> DISPENSER_CONTAINERS = new HashSet<>(Arrays.asList(Material.DISPENSER, Material.DROPPER, Material.FURNACE, Material.BLAST_FURNACE, Material.SMOKER));
